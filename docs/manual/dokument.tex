...
\documentclass[12pt,twoside,a4paper,openany]{article}
    ...
    \title{Macierz i Testowanie usługi Github Copilot}		%...Wpisać nazwę projektu...
    \authorI{Mateusz Stanek}
    \authorII{Dawid Szołdra}		%jeśli są dwie osoby w projekcie to zostawiamy:    \authorII{}
